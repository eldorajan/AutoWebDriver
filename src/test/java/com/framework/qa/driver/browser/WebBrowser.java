...
public enum WebBrowser {
	Firefox("firefox"), InternetExplorer("ie"), Edge("edge"), Chrome("chrome"), HtmlUnit("htmlunit"), Safari(
			"safari"), Opera("opera"), Android("android"), IPhone("iphone"), IPad("ipad"), PhantomJS("phantomjs");
