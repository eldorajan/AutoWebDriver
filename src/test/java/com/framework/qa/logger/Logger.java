...
public class Logger {
	...
	protected static String loggerDirectory = FrameworkConstants.LOGGER_FOLDER;
	...
	public synchronized static org.apache.log4j.Logger getLogger() {
		if (!isConfigured) {
			PropertyConfigurator
					.configure(loggerDirectory + org.apache.commons.io.FilenameUtils.separatorsToSystem(loggerFile));
			isConfigured = true;
		}
		return org.apache.log4j.Logger.getLogger(getClassName());
	}
	...
	public synchronized static String getClassName() {
		try {
			return Thread.currentThread().getContextClassLoader()
					.loadClass(Thread.currentThread().getStackTrace()[4].getClassName()).getName();
