...
public class BaseElement implements WebElement {
     ...
     *
     * @return {@code WebElement} representing selected radio button or {@code null}
    ...
    /**
     * Indicates whether this select element support selecting multiple options at
     * the same time. This is done by checking the value of the "multiple"
     * attribute.
     *
     * @return {@code true} if select element support selecting multiple options and
     ...
     * multiple selections.
     *
     * @throws UnsupportedOperationException If the SELECT does not support multiple
     *                                       selections
     */
